...
When a definition has multiple cases, the cases above have precedence over the cases below.
For example, in the equation below, when both conditions $a$ and $b$ hold, $x$ below is defined to be $y$:
\begin{equation} \nonumber
x \equiv \begin{cases}
y & \text{if condition}\, a\,\text{holds}\\
z & \text{if condition}\, b\,\text{holds}\\
w & \text{otherwise}
\end{cases}
\end{equation}
